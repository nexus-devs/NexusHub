...
<script>
import itemGrid from 'src/components/search/results/results-grid-snippet.vue'
import itemList from 'src/components/search/results/results-list-snippet.vue'
