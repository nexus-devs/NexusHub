<template>
  <div class="order" @click="active ? null : select()">
    <!-- Order listing -->
    <div class="row">
      <router-link :to="`/wow-classic/items/${activeServer.slug ? `${activeServer.slug}/` : ''}${crafting.uniqueName}`" class="image-wrapper">
        <img :src="crafting.icon" :alt="crafting.name">
        <img :src="crafting.icon" :alt="crafting.name" class="blur">
      </router-link>
      <router-link :to="`/wow-classic/items/${activeServer.slug ? `${activeServer.slug}/` : ''}${crafting.uniqueName}`" class="item col">
    ...
    <div :class="{ active }" class="selection">
      <div v-for="(reagent) in crafting.reagents" :key="reagent.itemId" class="row">
        <router-link :to="`/wow-classic/items/${activeServer.slug ? `${activeServer.slug}/` : ''}${reagent.uniqueName}`" class="image-wrapper">
          <img :src="reagent.icon" :alt="reagent.name">
          <img :src="reagent.icon" :alt="reagent.name" class="blur">
        </router-link>
        <router-link :to="`/wow-classic/items/${activeServer.slug ? `${activeServer.slug}/` : ''}${reagent.uniqueName}`" class="item col reagent">
