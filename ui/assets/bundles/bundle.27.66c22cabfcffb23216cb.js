...
// CONCATENATED MODULE: ./ui/store/analytics.js
/* harmony default export */ var analytics = ({
  name: 'analytics',
  state: {
    users: null,
    views: null
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./ui/sites/company.vue?vue&type=script&lang=js&





const parseNum = num => (Math.round(num / 1000) * 1000).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',');
...
/* harmony default export */ var companyvue_type_script_lang_js_ = ({
  ...
  async asyncData() {
    ...
    await Promise.all([this.$cubic.get('/analytics/v1/ga/users').then(data => {
      users = data;
    }), this.$cubic.get('/analytics/v1/ga/views').then(data => {
      views = data;
    }), this.$cubic.get('/warframe/v1/analytics/orders').then(data => {
      offers = data;
    })]);
...
// CONCATENATED MODULE: ./ui/sites/company.vue?vue&type=script&lang=js&
 /* harmony default export */ var sites_companyvue_type_script_lang_js_ = (companyvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./ui/sites/company.vue?vue&type=style&index=0&id=16a55c3b&lang=scss&scoped=true&
var companyvue_type_style_index_0_id_16a55c3b_lang_scss_scoped_true_ = __webpack_require__(526);

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./ui/sites/company.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  sites_companyvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
