...
var vue_highlightjs = __webpack_require__(196);
...
// CONCATENATED MODULE: ./ui/components/developers/sidebar.vue?vue&type=script&lang=js&
 /* harmony default export */ var developers_sidebarvue_type_script_lang_js_ = (sidebarvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./ui/components/developers/sidebar.vue?vue&type=style&index=0&id=32695e3e&lang=scss&scoped=true&
var sidebarvue_type_style_index_0_id_32695e3e_lang_scss_scoped_true_ = __webpack_require__(520);

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./ui/components/developers/sidebar.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  developers_sidebarvue_type_script_lang_js_,
  sidebarvue_type_template_id_32695e3e_scoped_true_render,
  sidebarvue_type_template_id_32695e3e_scoped_true_staticRenderFns,
  false,
  null,
  "32695e3e",
  null
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./ui/sites/developers/api/index.vue?vue&type=script&lang=js&
...
const apivue_type_script_lang_js_title = str => str.toLowerCase().replace(/\b\w/g, l => l.toUpperCase());
  ...
  computed: {
    ...
    groups() {
      ...
      for (const endpoint of this.endpoints) {
        ...
        if (split.length > 2) {
          const group = split[1];
          const name = apivue_type_script_lang_js_title(`${split[1]}${split.length > 3 ? ` / ${split[3]}` : ''}`);
          const saved = groups.find(g => g.name === name);
    ...
    endpoint() {
      ...
      if (group && groups) {
        return groups.find(g => g.name.replace(/\-/g, ' / ') === group.replace(/\-/g, ' / ')).endpoints.find(e => e.name === name);
      }
...
// CONCATENATED MODULE: ./ui/sites/developers/api/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var developers_apivue_type_script_lang_js_ = (apivue_type_script_lang_js_); 
// EXTERNAL MODULE: ./ui/sites/developers/api/index.vue?vue&type=style&index=0&id=4ff9d7da&lang=scss&scoped=true&
var apivue_type_style_index_0_id_4ff9d7da_lang_scss_scoped_true_ = __webpack_require__(521);

// CONCATENATED MODULE: ./ui/sites/developers/api/index.vue
...
var api_component = Object(componentNormalizer["a" /* default */])(
  developers_apivue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var api = __webpack_exports__["default"] = (api_component.exports);
